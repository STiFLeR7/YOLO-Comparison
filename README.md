...
For detailed performance metrics and visualizations, refer to [Comparisons.md]([comparisons.md](https://github.com/STiFLeR7/YOLO-Comparison/blob/master/comparisons.md)).
