...
def evaluate_map(model_path, dataset_yaml):
    ...
    print("\nYOLOv9 Model Evaluation Results (mAP at Different IoU Thresholds):")
    print(table)

if __name__ == '__main__':
    model_path = 'D:/YOLO-Comparison/results/v9/train/weights/best.pt'  # Update with your YOLOv9 model path
